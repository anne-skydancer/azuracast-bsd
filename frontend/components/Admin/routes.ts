...
export default function useAdminRoutes(): RouteRecordRaw[] {
    return [
        ...
        },
        {
            path: "/admin",
            component: () =>
                import("~/components/Admin/AdminSidebarWrapper.vue"),
            children: [
                {
                    path: "api-keys",
                ...
                },
                {
                    path: "settings",
                    component: () =>
                        import("~/components/Admin/SettingsWrapper.vue"),
                ...
                },
                {
                    ...
                    component: () =>
                        import("~/components/Admin/StorageLocations.vue"),
                    name: "admin:storage_locations:index",
                },
                {
                    path: "backups",
                    component: () =>
                        import("~/components/Admin/BackupsWrapper.vue"),
                ...
                },
                {
                    path: "permissions",
                    component: () =>
                        import("~/components/Admin/PermissionsWrapper.vue"),
                ...
                },
                {
                    path: "custom_fields",
                    component: () =>
                        import("~/components/Admin/CustomFields.vue"),
